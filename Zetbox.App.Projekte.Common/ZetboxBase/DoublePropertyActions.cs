...
namespace Zetbox.App.Base
{
    ...
    public static class DoublePropertyActions
    {
        ...
        [Invocation]
        public static async System.Threading.Tasks.Task GetElementTypeString(DoubleProperty obj, MethodReturnEventArgs<string> e)
        {
            e.Result = "double";
        ...
        [Invocation]
        public static async System.Threading.Tasks.Task GetPropertyTypeString(DoubleProperty obj, MethodReturnEventArgs<string> e)
        {
