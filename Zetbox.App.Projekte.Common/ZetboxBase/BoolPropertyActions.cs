...
namespace Zetbox.App.Base
{
    ...
    public static class BoolPropertyActions
    {
        ...
        [Invocation]
        public static async System.Threading.Tasks.Task GetElementTypeString(BoolProperty obj, MethodReturnEventArgs<string> e)
        {
            e.Result = "bool";
        ...
        [Invocation]
        public static async System.Threading.Tasks.Task GetPropertyTypeString(BoolProperty obj, MethodReturnEventArgs<string> e)
        {
