...
namespace Zetbox.App.Base
{
    ...
    public static class DecimalPropertyActions
    {
        ...
        [Invocation]
        public static async System.Threading.Tasks.Task GetElementTypeString(DecimalProperty obj, MethodReturnEventArgs<string> e)
        {
            e.Result = "decimal";
        ...
        [Invocation]
        public static async System.Threading.Tasks.Task GetPropertyTypeString(DecimalProperty obj, MethodReturnEventArgs<string> e)
        {
