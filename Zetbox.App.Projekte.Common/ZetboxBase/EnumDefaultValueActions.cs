namespace Kistl.App.Base
{
    ...
    {
        [Invocation]
        public static void GetDefaultValue(Kistl.App.Base.EnumDefaultValue obj, MethodReturnEventArgs<object> e)
        {
            e.Result = obj.EnumValue.Value;
        }

        [Invocation]
        public static void ToString(Kistl.App.Base.EnumDefaultValue obj, MethodReturnEventArgs<System.String> e)
        {
