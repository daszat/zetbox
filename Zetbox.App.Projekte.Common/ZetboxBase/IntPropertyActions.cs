...
namespace Zetbox.App.Base
{
    ...
    public static class IntPropertyActions
    {
        ...
        [Invocation]
        public static async System.Threading.Tasks.Task GetElementTypeString(IntProperty obj, MethodReturnEventArgs<string> e)
        {
            e.Result = "int";
        ...
        [Invocation]
        public static async System.Threading.Tasks.Task GetPropertyTypeString(IntProperty obj, MethodReturnEventArgs<string> e)
        {
