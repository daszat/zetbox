...
namespace Zetbox.App.Base
{
    ...
    public static class ObjectReferencePlaceholderPropertyActions
    {
        ...
        [Invocation]
        public static async System.Threading.Tasks.Task GetElementTypeString(ObjectReferencePlaceholderProperty obj, MethodReturnEventArgs<string> e)
        {
            var def = obj.ReferencedObjectClass;
            if (def == null)
            {
        ...
        [Invocation]
        public static async System.Threading.Tasks.Task GetPropertyTypeString(ObjectReferencePlaceholderProperty obj, MethodReturnEventArgs<string> e)
        {
