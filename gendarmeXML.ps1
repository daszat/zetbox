...
gendarme -config $SolutionDir\gendarmerules.xml --xml $SolutionDir\bin\gendarme.xml --ignore $SolutionDir\gendarmeignore.txt --severity high+ $SolutionDir\bin\Debug\bin\Common\Kistl.API.dll $SolutionDir\bin\Debug\bin\Common\Kistl.App.Projekte.Common.dll $SolutionDir\bin\Debug\bin\Common\TempAppHelpers.dll $SolutionDir\bin\Debug\bin\Client\Kistl.API.Client.dll $SolutionDir\bin\Debug\bin\Client\Kistl.App.Projekte.Client.dll $SolutionDir\bin\Debug\bin\Client\Kistl.Client.ASPNET.Toolkit.dll $SolutionDir\bin\Debug\bin\Client\Kistl.Client.dll $SolutionDir\bin\Debug\bin\Client\Kistl.Client.Forms.exe $SolutionDir\bin\Debug\bin\Client\Kistl.Client.WPF.exe $SolutionDir\bin\Debug\bin\Client\Kistl.DalProvider.ClientObjects.dll $SolutionDir\bin\Debug\bin\Server\Kistl.API.Server.dll $SolutionDir\bin\Debug\bin\Server\Kistl.App.Projekte.Server.dll $SolutionDir\bin\Debug\bin\Server\Kistl.DalProvider.EF.dll $SolutionDir\bin\Debug\bin\Common\Kistl.DalProvider.Memory.dll $SolutionDir\bin\Debug\bin\Server\Kistl.DalProvider.Memory.Generator.dll $SolutionDir\bin\Debug\bin\Server\Kistl.Server.dll $SolutionDir\bin\Debug\bin\Server\Kistl.Server.Service.exe $SolutionDir\bin\Debug\bin\Server\Kistl.Server.Service32.exe
