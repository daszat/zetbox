namespace Kistl.App.Base
{
    ...
    {
        [Invocation]
        public static void NotifyCreated(Kistl.App.Base.DoubleProperty obj)
        {
            obj.ValueModelDescriptor = ViewModelDescriptors.Kistl_Client_Presentables_ValueViewModels_NullableStructValueViewModel_1_System_Double_.Find(obj.Context);
        }
    }
}
