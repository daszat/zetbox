namespace Kistl.App.Base
{
    ...
    {
        [Invocation]
        public static void NotifyCreated(Kistl.App.Base.BoolProperty obj)
        {
            obj.ValueModelDescriptor = ViewModelDescriptors.Kistl_Client_Presentables_ValueViewModels_NullableBoolPropertyViewModel.Find(obj.Context);
        }
    }
}
