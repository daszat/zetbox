...
namespace Zetbox.App.Test
{
    ...
    public interface Muhblah_StringCollection_CollectionEntry : IValueCollectionEntry<Muhblah, string> 
    {
...
namespace Zetbox.App.GUI
{
    ...
    /// <summary>
    /// ValueCollectionEntry for A View supports one or more ViewModels.
    /// </summary>
    [Zetbox.API.DefinitionGuid("b898a824-578e-45e0-a312-193068a2b139")]
    public interface ViewDescriptor_SupportedViewModelRefs_CollectionEntry : IValueCollectionEntry<ViewDescriptor, string> 
    {
...
namespace Zetbox.App.Projekte
{
    ...
    public interface Projekt_AuditJournal_CollectionEntry : IValueCollectionEntry<Projekt, Zetbox.App.Base.AuditEntry> 
    {
