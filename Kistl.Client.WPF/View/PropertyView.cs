...
namespace Kistl.Client.WPF.View
{
    ...
    public class PropertyView : UserControl
    {
        ...
        private StackPanel _errorReporter = new StackPanel();
        ...
        public PropertyView()
        {
            ...
            Grid.SetColumn(_errorReporter, EditPartColumn);
        ...
        public static readonly DependencyProperty LabelProperty =
            DependencyProperty.Register("Label", typeof(UIElement), typeof(PropertyView), new UIPropertyMetadata(LabelChangedCallback));

        private static void LabelChangedCallback(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            PropertyView p = (PropertyView)d;
        ...
        public FrameworkElement EditPart
        {
            get { return (FrameworkElement)GetValue(EditPartProperty); }
        ...
        public static readonly DependencyProperty EditPartProperty =
            DependencyProperty.Register("EditPart", typeof(FrameworkElement), typeof(PropertyView), new UIPropertyMetadata(EditPartChangedCallback));

        private static void EditPartChangedCallback(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            var p = (PropertyView)d;
            var old = e.OldValue as FrameworkElement;
            if (e.OldValue != null)
                p._grid.Children.Remove(old);

            Grid.SetColumn(p.EditPart, EditPartColumn);
