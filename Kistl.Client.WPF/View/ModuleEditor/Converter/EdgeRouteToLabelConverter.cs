...
namespace Kistl.Client.WPF.View.ModuleEditor.Converter
{
    ...
    public class EdgeRouteToLabelConverter : IMultiValueConverter
    {
        public object Convert(object[] values, Type targetType, object parameter, System.Globalization.CultureInfo culture)
        {
            ...
            {
                throw new ArgumentException("EdgeRouteToLabelConverter should have 11 parameters: " +
                    "pos (1,2), size (3,4) of source; pos (5,6), size (7,8) of target; routeInformation (9); size(10,11) of actual element.");
            }
            ...
            //get the size of the target
            Vector selftSize = new Vector()
            {
                X = (values[9] != DependencyProperty.UnsetValue ? (double)values[9] : 0.0),
                Y = (values[10] != DependencyProperty.UnsetValue ? (double)values[10] : 0.0)
            };
            ...
            Point mid = p1 + ((p2 - p1) / 2) - (selftSize / 2);
