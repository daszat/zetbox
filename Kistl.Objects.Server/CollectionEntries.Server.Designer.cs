...
#region Serializer
        ...
        {
            XmlStreamer.ToStream(A != null ? A.ExportGuid : (Guid?)null, xml, "A", "http://dasz.at/Kistl");
            XmlStreamer.ToStream(B != null ? B.ExportGuid : (Guid?)null, xml, "B", "http://dasz.at/Kistl");
        }
