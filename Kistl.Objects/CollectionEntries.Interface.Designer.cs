...
namespace Kistl.App.Test
{
    ...
    /// ObjectCollectionEntry for 
    /// </summary>
    public interface TestStudent_füllt_aus_Fragebogen_RelationEntry : IRelationCollectionEntry<TestStudent, Fragebogen> 
    {
...
namespace Kistl.App.Base
{
    ...
    /// </summary>
    public interface UniqueConstraint_ensures_unique_on_Property_RelationEntry : IRelationCollectionEntry<UniqueConstraint, Property> 
    {
...
namespace Kistl.App.GUI
{
    ...
    /// ObjectCollectionEntry for 
    /// </summary>
    public interface ViewDescriptor_supports_TypeRef_RelationEntry : IRelationCollectionEntry<ViewDescriptor, TypeRef> 
    {
...
namespace Kistl.App.GUI
{
    ...
    /// </summary>
    public interface ViewModelDescriptor_displayedBy_ControlKind_RelationEntry : IRelationCollectionEntry<ViewModelDescriptor, ControlKind> 
    {
