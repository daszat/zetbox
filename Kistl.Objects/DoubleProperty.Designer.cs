...
namespace Kistl.App.Base
{
    ...
    public class DoubleProperty : Kistl.App.Base.ValueTypeProperty
    {
        ...
        public event GetDatabaseType_Handler<DoubleProperty> OnGetDatabaseType_DoubleProperty;
        ...
        public override string GetDatabaseType()
        {
            ...
            if (OnGetDatabaseType_DoubleProperty != null)
            {
                OnGetDatabaseType_DoubleProperty(this, e);
            }
            return e.Result;
        }
