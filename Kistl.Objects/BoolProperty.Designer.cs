...
namespace Kistl.App.Base
{
    ...
    public class BoolProperty : Kistl.App.Base.ValueTypeProperty
    {
        ...
        public event GetDatabaseType_Handler<BoolProperty> OnGetDatabaseType_BoolProperty;
        ...
        public override string GetDatabaseType()
        {
            ...
            if (OnGetDatabaseType_BoolProperty != null)
            {
                OnGetDatabaseType_BoolProperty(this, e);
            }
            return e.Result;
        }
