...
namespace Kistl.App.Base
{
    ...
    public class ObjectReferenceProperty : Kistl.App.Base.Property
    {
        ...
        public event GetDatabaseType_Handler<ObjectReferenceProperty> OnGetDatabaseType_ObjectReferenceProperty;
        ...
        public override string GetDatabaseType()
        {
            ...
            if (OnGetDatabaseType_ObjectReferenceProperty != null)
            {
                OnGetDatabaseType_ObjectReferenceProperty(this, e);
            }
            return e.Result;
        }
