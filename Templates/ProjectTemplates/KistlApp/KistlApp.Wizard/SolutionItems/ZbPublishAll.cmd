...
Kistl.Server.Service.exe %config% -publish Modules\$safesolutionname$.xml -ownermodules $safesolutionname$;$safesolutionname$.Config
IF ERRORLEVEL 1 GOTO FAIL

rem export $safesolutionname$.Config data
rem Kistl.Server.Service.exe %config% -export Data\$safesolutionname$.Config.xml -schemamodules $safesolutionname$.Config
rem IF ERRORLEVEL 1 GOTO FAIL

rem export $safesolutionname$.Data data
rem Kistl.Server.Service.exe %config% -export Data\$safesolutionname$.Data.xml -schemamodules $safesolutionname$ -ownermodules $safesolutionname$
rem IF ERRORLEVEL 1 GOTO FAIL
