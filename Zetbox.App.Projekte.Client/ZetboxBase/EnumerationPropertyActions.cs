...
namespace Zetbox.App.Base
{
    ...
    {
        [Invocation]
        public static System.Threading.Tasks.Task NotifyCreated(Zetbox.App.Base.EnumerationProperty obj)
        {
            obj.ValueModelDescriptor = ViewModelDescriptors.Zetbox_Client_Presentables_ValueViewModels_EnumerationValueViewModel.Find(obj.Context);
