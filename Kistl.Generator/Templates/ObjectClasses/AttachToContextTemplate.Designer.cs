...
#line 24 "P:\Kistl\Kistl.Generator\Templates\ObjectClasses\AttachToContextTemplate.cst"
}

			foreach(var prop in cls.Properties.OfType<CompoundObjectProperty>().Where(p => p.IsList).OrderBy(p => p.Name))
			{

#line 29 "P:\Kistl\Kistl.Generator\Templates\ObjectClasses\AttachToContextTemplate.cst"
this.WriteObjects("			_",  prop.Name , ".ForEach<IValueCollectionEntry>(i => ctx.Attach(i));\r\n");
#line 31 "P:\Kistl\Kistl.Generator\Templates\ObjectClasses\AttachToContextTemplate.cst"
}
