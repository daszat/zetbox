...
{
    [Arebis.CodeGeneration.TemplateInfo(@"/srv/CCNet/Projects/zbox/repo/Kistl.Generator/Templates/Module.cst")]
    public partial class Module : Kistl.Generator.ResourceTemplate
    {
        ...
        {
#line 11 "/srv/CCNet/Projects/zbox/repo/Kistl.Generator/Templates/Module.cst"
...
#line 21 "/srv/CCNet/Projects/zbox/repo/Kistl.Generator/Templates/Module.cst"
foreach(string ns in GetAdditionalImports().OrderBy(s => s).Distinct().OrderBy(s => s)) { 
#line 22 "/srv/CCNet/Projects/zbox/repo/Kistl.Generator/Templates/Module.cst"
this.WriteObjects("    using ",  ns , ";\r\n");
#line 23 "/srv/CCNet/Projects/zbox/repo/Kistl.Generator/Templates/Module.cst"
} 
#line 24 "/srv/CCNet/Projects/zbox/repo/Kistl.Generator/Templates/Module.cst"
this.WriteObjects("\r\n");
...
this.WriteObjects("\r\n");
#line 32 "/srv/CCNet/Projects/zbox/repo/Kistl.Generator/Templates/Module.cst"
ApplyRegistrations(); 
#line 33 "/srv/CCNet/Projects/zbox/repo/Kistl.Generator/Templates/Module.cst"
this.WriteObjects("        }\r\n");
this.WriteObjects("    }\r\n");
this.WriteObjects("\r\n");
#line 36 "/srv/CCNet/Projects/zbox/repo/Kistl.Generator/Templates/Module.cst"
ApplyTypeCheckerTemplate(); 
#line 37 "/srv/CCNet/Projects/zbox/repo/Kistl.Generator/Templates/Module.cst"
this.WriteObjects("\r\n");
