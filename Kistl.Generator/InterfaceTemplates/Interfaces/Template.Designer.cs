...
{
    [Arebis.CodeGeneration.TemplateInfo(@"/srv/CCNet/Projects/zbox/repo/Kistl.Generator/InterfaceTemplates/Interfaces/Template.cst")]
    public partial class Template : Kistl.Generator.ResourceTemplate
    {
        ...
        {
#line 14 "/srv/CCNet/Projects/zbox/repo/Kistl.Generator/InterfaceTemplates/Interfaces/Template.cst"
...
this.WriteObjects("    {\r\n");
#line 29 "/srv/CCNet/Projects/zbox/repo/Kistl.Generator/InterfaceTemplates/Interfaces/Template.cst"
foreach(Property p in dataType.Properties.OrderBy(p => p.Name))
    {
        if (!IsDeclaredInImplementsInterface(p))
        {

#line 34 "/srv/CCNet/Projects/zbox/repo/Kistl.Generator/InterfaceTemplates/Interfaces/Template.cst"
this.WriteObjects("\r\n");
this.WriteObjects("        /// <summary>\r\n");
this.WriteObjects("        /// ",  p.Description , "\r\n");
this.WriteObjects("        /// </summary>\r\n");
#line 39 "/srv/CCNet/Projects/zbox/repo/Kistl.Generator/InterfaceTemplates/Interfaces/Template.cst"
...
#line 51 "/srv/CCNet/Projects/zbox/repo/Kistl.Generator/InterfaceTemplates/Interfaces/Template.cst"
this.WriteObjects("\r\n");
this.WriteObjects("        /// <summary>\r\n");
this.WriteObjects("        /// ",  m.Description , "\r\n");
this.WriteObjects("        /// </summary>\r\n");
#line 56 "/srv/CCNet/Projects/zbox/repo/Kistl.Generator/InterfaceTemplates/Interfaces/Template.cst"
ApplyMethodTemplate(m, index++);
            }
        }
    }

#line 61 "/srv/CCNet/Projects/zbox/repo/Kistl.Generator/InterfaceTemplates/Interfaces/Template.cst"
this.WriteObjects("    }\r\n");
this.WriteObjects("}\r\n");
