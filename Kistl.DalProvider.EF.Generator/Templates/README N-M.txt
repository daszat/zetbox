...
Actual class names are postfixed "Impl" to lessen possibilities 
of name-clashes.
		...
		: ObjectClass
	{
		...
		EntityCollection<ObjectClass_ImplementsInterfacesCollectionEntryImpl> ImplementsInterfacesImpl { get; }
...
Interface's
	...
	class ObjectClass_ImplementsInterfacesCollectionEntryImpl
	{
		...
		[EdmRelationshipNavigationPropertyAttribute("Model",
			...
			"A_Interface")]
		public InterfaceImpl ValueImpl { get; set; }
...
[assembly: EdmRelationship("Model", "FK_ObjectClass_ImplementsInterfacesCollectionEntry_ObjectClass_fk_Parent",
	"A_ObjectClass", RelationshipMultiplicity.ZeroOrOne, typeof(ObjectClassImpl),
	"B_ObjectClass_ImplementsInterfacesCollectionEntry",
	                 RelationshipMultiplicity.Many,      typeof(ObjectClass_ImplementsInterfacesCollectionEntryImpl))]

[assembly: EdmRelationship("Model", "FK_ObjectClass_ImplementsInterfacesCollectionEntry_Interface_ImplementsInterfaces",
	"A_Interface", RelationshipMultiplicity.ZeroOrOne, typeof(InterfaceImpl),
	"B_ObjectClass_ImplementsInterfacesCollectionEntry",
	               RelationshipMultiplicity.Many,      typeof(ObjectClass_ImplementsInterfacesCollectionEntryImpl))]
...
## CSDL
	...
	<EntityType Name="ObjectClass">
		...
		<NavigationProperty Name="ImplementsInterfacesImpl"
...
`ObjectClass_ImplementsInterfacesCollectionEntryImpl` class. 
Only the returned wrapper is different to implement the appropriate semantics.
	...
	class Interface {
		...
		[EdmRelationshipNavigationProperty("Model", "FK_ObjectClass_ImplementsInterfacesCollectionEntry_Interface_ImplementsInterfaces",
			"B_ObjectClass_ImplementsInterfacesCollectionEntry")]
		EntityCollection<ObjectClass_ImplementsInterfacesCollectionEntryImpl> ImplementedByImpl { get; }
...
Only the new `NavigationProperty` has to be added:
	...
	<NavigationProperty Name="ImplementedByImpl"
		Relationship="Model.FK_ObjectClass_ImplementsInterfacesCollectionEntry_Interface_ImplementsInterfaces"
