...
{
    [Arebis.CodeGeneration.TemplateInfo(@"P:\Kistl\Kistl.DalProvider.EF\Generator\Implementation\ObjectClasses\CollectionEntryListProperty.cst")]
    public partial class CollectionEntryListProperty : Kistl.Server.Generators.KistlCodeTemplate
    {
        ...
        public CollectionEntryListProperty(Arebis.CodeGeneration.IGenerationHost _host, IKistlContext ctx, Kistl.Server.Generators.Templates.Implementation.SerializationMembersList serializationList, Relation rel, RelationEndRole endRole)
            : base(_host)
        {
			this.ctx = ctx;
        ...
        {
#line 19 "P:\Kistl\Kistl.DalProvider.EF\Generator\Implementation\ObjectClasses\CollectionEntryListProperty.cst"
...
#line 81 "P:\Kistl\Kistl.DalProvider.EF\Generator\Implementation\ObjectClasses\CollectionEntryListProperty.cst"
