...
namespace Kistl.DalProvider.EF.Generator.Implementation.ObjectClasses
{
    public partial class CompoundObjectPropertyTemplate
    {
        ...
        {
            if (list != null)
                list.Add("Implementation.ObjectClasses.CompoundObjectSerialization", Kistl.Server.Generators.Templates.Implementation.SerializerType.All, this.prop.Module.Namespace, memberName, memberName);
        }
    }
}
