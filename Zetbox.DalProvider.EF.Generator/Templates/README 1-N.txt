...
of name-clashes.
	...
	class ModuleImpl : Module
	{
		...
		EntityCollection<AssemblyImpl> AssembliesImpl { get; }
...
the underlying Relationship:
	...
	[assembly: EdmRelationship("Model", "FK_Assembly_Module_Module",
		"A_Module",   RelationshipMultiplicity.ZeroOrOne, typeof(ModuleImpl),
		"B_Assembly", RelationshipMultiplicity.Many,      typeof(AssemblyImpl))]
...
## CSDL
	...
	<EntityType Name="Module">
		...
		<NavigationProperty Name="AssembliesImpl"
	...
	<EntityType Name="Assembly">
		...
		<Property Name="ID" Type="Int32" Nullable="false" />
		<NavigationProperty Name="ModuleImpl"
			Relationship="Model.FK_Assembly_Module_Module"
			FromRole="B_Assembly"
			ToRole="A_Module" />
	</EntityType>
