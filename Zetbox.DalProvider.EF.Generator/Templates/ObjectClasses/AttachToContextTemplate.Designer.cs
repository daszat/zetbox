...
#line 39 "P:\zetbox\Zetbox.DalProvider.EF.Generator\Templates\ObjectClasses\AttachToContextTemplate.cst"
this.WriteObjects("            if (_",  prop.Name , " != null)\r\n");
this.WriteObjects("                ",  prop.Name , "Impl.ForEach<IPersistenceObject>(i => ctx.Attach(i));\r\n");
#line 42 "P:\zetbox\Zetbox.DalProvider.EF.Generator\Templates\ObjectClasses\AttachToContextTemplate.cst"
}

            foreach(var prop in cls.Properties.OfType<CompoundObjectProperty>().Where(p => p.IsList).OrderBy(p => p.Name))
            {

#line 47 "P:\zetbox\Zetbox.DalProvider.EF.Generator\Templates\ObjectClasses\AttachToContextTemplate.cst"
this.WriteObjects("            if (_",  prop.Name , " != null)\r\n");
this.WriteObjects("                ",  prop.Name , "Impl.ForEach<IPersistenceObject>(i => ctx.Attach(i));\r\n");
#line 50 "P:\zetbox\Zetbox.DalProvider.EF.Generator\Templates\ObjectClasses\AttachToContextTemplate.cst"
}

#line 52 "P:\zetbox\Zetbox.DalProvider.EF.Generator\Templates\ObjectClasses\AttachToContextTemplate.cst"
this.WriteObjects("        }\r\n");
