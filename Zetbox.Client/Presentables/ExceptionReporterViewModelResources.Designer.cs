...
namespace Zetbox.Client.Presentables {
    ...
    internal class ExceptionReporterViewModelResources {
        ...
        /// <summary>
        ///   Looks up a localized string similar to There was an error communicating with the server. Please tell you network administrator the following error code: {0}.
        /// </summary>
        internal static string CommunicationError_MessageFormat {
            get {
                return ResourceManager.GetString("CommunicationError_MessageFormat", resourceCulture);
            }
        }
        ...
        /// </summary>
        internal static string CommunicationError_Title {
            get {
                return ResourceManager.GetString("CommunicationError_Title", resourceCulture);
            }
        }
        ...
        /// </summary>
        internal static string HelpUsText {
            get {
                return ResourceManager.GetString("HelpUsText", resourceCulture);
            }
        }
