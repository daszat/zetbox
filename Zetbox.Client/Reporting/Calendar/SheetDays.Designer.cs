...
#line 14 "P:\zetbox\Zetbox.Client\Reporting\Calendar\SheetDays.cst"
foreach (var grp in events.Where(e => e.From.Date >= start && e.From.Date <= end).GroupBy(k => k.From.Date).OrderBy(g => g.Key)) { 
...
this.WriteObjects("                    ] { ",  grp.Key.ToString("dddd, dd MMMM yyyy") , " }\r\n");
this.WriteObjects("                }\r\n");
this.WriteObjects("                \\row [ Height = \"3cm\" ] {\r\n");
this.WriteObjects("                    \\cell { }\r\n");
this.WriteObjects("                    \\cell [ Borders { Right { Width = 0 } } ] { }\r\n");
this.WriteObjects("                    \\cell [ Borders { Left  { Width = 0 } } ] { ",  string.Join(" \\linebreak ", grp.Where(e => e.IsAllDay).Select(e => Format(e.Summary))) , " }\r\n");
this.WriteObjects("                }\r\n");
#line 47 "P:\zetbox\Zetbox.Client\Reporting\Calendar\SheetDays.cst"
for(int hour = 0; hour < 24; hour++) { 
#line 48 "P:\zetbox\Zetbox.Client\Reporting\Calendar\SheetDays.cst"
...
this.WriteObjects("                    \\cell [ Borders { Left  { Width = 0 } } ] { ",  string.Join(", ", grp.Where(e => !e.IsAllDay && e.From.Hour == hour).Select(e => Format(e.Summary))) , " }\r\n");
this.WriteObjects("                }\r\n");
#line 56 "P:\zetbox\Zetbox.Client\Reporting\Calendar\SheetDays.cst"
} 
#line 57 "P:\zetbox\Zetbox.Client\Reporting\Calendar\SheetDays.cst"
this.WriteObjects("            }\r\n");
this.WriteObjects("        }\r\n");
this.WriteObjects("    }\r\n");
