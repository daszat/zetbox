...
namespace Microsoft.Samples.KMoore.WPFSamples.TreeViewHelperClasses
{
    public static class TreeViewHelper
    {
        ...
        public static List<TreeViewItem> GetTreeViewItems(TreeView treeView)
        {
            return GetItemsInternal(treeView);
        }
        public static List<TreeViewItem> GetTreeViewItems(TreeViewItem treeView)
        {
            return GetItemsInternal(treeView);
        }
        ...
        private static List<TreeViewItem> GetItemsInternal(ItemsControl treeViewThing)
        {
            ValidateItemsControl(treeViewThing);

            List<TreeViewItem> nodes = new List<TreeViewItem>();

            foreach (object item in treeViewThing.Items)
            {
        ...
        private delegate TreeViewItem ShowItemInternalDelegate(ItemsControl treeViewThing, object[] objectPath, int[] indexPath);
        private static readonly ShowItemInternalDelegate ShowItemInternalDelegateInstance =
            new ShowItemInternalDelegate(ShowItemInternal);
        #endregion
