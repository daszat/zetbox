...
{
    [Arebis.CodeGeneration.TemplateInfo(@"C:\projects\zetbox\Zetbox.Generator\InterfaceTemplates\CollectionEntries\Template.cst")]
    public partial class Template : Zetbox.Generator.ResourceTemplate
    {
        ...
        {
#line 30 "C:\projects\zetbox\Zetbox.Generator\InterfaceTemplates\CollectionEntries\Template.cst"
this.WriteObjects("// <autogenerated/>\r\n");
this.WriteObjects("\r\n");
this.WriteObjects("namespace ",  module.Namespace , "\r\n");
this.WriteObjects("{\r\n");
this.WriteObjects("    using Zetbox.API;\r\n");
#line 36 "C:\projects\zetbox\Zetbox.Generator\InterfaceTemplates\CollectionEntries\Template.cst"
foreach(string ns in GetAdditionalImports().Distinct().OrderBy(s => s))
    {

#line 39 "C:\projects\zetbox\Zetbox.Generator\InterfaceTemplates\CollectionEntries\Template.cst"
this.WriteObjects("    using ",  ns , ";\r\n");
#line 41 "C:\projects\zetbox\Zetbox.Generator\InterfaceTemplates\CollectionEntries\Template.cst"
}

#line 43 "C:\projects\zetbox\Zetbox.Generator\InterfaceTemplates\CollectionEntries\Template.cst"
this.WriteObjects("\r\n");
