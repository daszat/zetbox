...
namespace Zetbox.Generator.InterfaceTemplates.CollectionEntries
{
    ...
    public partial class Template : Zetbox.Generator.ResourceTemplate
    {
        ...
        {
#line 14 "P:\zetbox\Zetbox.Generator\InterfaceTemplates\CollectionEntries\Template.cst"
this.WriteObjects("// <autogenerated/>\r\n");
this.WriteObjects("\r\n");
this.WriteObjects("namespace ",  module.Namespace , "\r\n");
this.WriteObjects("{\r\n");
this.WriteObjects("    using Zetbox.API;\r\n");
#line 20 "P:\zetbox\Zetbox.Generator\InterfaceTemplates\CollectionEntries\Template.cst"
foreach(string ns in GetAdditionalImports().Distinct().OrderBy(s => s))
    {

#line 23 "P:\zetbox\Zetbox.Generator\InterfaceTemplates\CollectionEntries\Template.cst"
this.WriteObjects("    using ",  ns , ";\r\n");
#line 25 "P:\zetbox\Zetbox.Generator\InterfaceTemplates\CollectionEntries\Template.cst"
}

#line 27 "P:\zetbox\Zetbox.Generator\InterfaceTemplates\CollectionEntries\Template.cst"
this.WriteObjects("\r\n");
