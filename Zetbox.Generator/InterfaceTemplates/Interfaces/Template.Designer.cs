...
{
    [Arebis.CodeGeneration.TemplateInfo(@"D:\Projects\zetbox.core\Zetbox.Generator\InterfaceTemplates\Interfaces\Template.cst")]
    public partial class Template : Zetbox.Generator.ResourceTemplate
    {
        ...
        {
#line 30 "D:\Projects\zetbox.core\Zetbox.Generator\InterfaceTemplates\Interfaces\Template.cst"
...
this.WriteObjects("    {\r\n");
#line 46 "D:\Projects\zetbox.core\Zetbox.Generator\InterfaceTemplates\Interfaces\Template.cst"
foreach(Property p in dataType.Properties.OrderBy(p => p.Name))
    {
        if (!IsDeclaredInImplementsInterface(p))
        {

#line 51 "D:\Projects\zetbox.core\Zetbox.Generator\InterfaceTemplates\Interfaces\Template.cst"
this.WriteObjects("\r\n");
this.WriteObjects("        /// <summary>\r\n");
this.WriteObjects("        /// ",  UglyXmlEncode(p.Description) , "\r\n");
this.WriteObjects("        /// </summary>\r\n");
#line 56 "D:\Projects\zetbox.core\Zetbox.Generator\InterfaceTemplates\Interfaces\Template.cst"
...
#line 68 "D:\Projects\zetbox.core\Zetbox.Generator\InterfaceTemplates\Interfaces\Template.cst"
this.WriteObjects("\r\n");
this.WriteObjects("        /// <summary>\r\n");
this.WriteObjects("        /// ",  UglyXmlEncode(m.Description) , "\r\n");
this.WriteObjects("        /// </summary>\r\n");
#line 73 "D:\Projects\zetbox.core\Zetbox.Generator\InterfaceTemplates\Interfaces\Template.cst"
ApplyMethodTemplate(m, index++);
            }
        }
    }

#line 78 "D:\Projects\zetbox.core\Zetbox.Generator\InterfaceTemplates\Interfaces\Template.cst"
this.WriteObjects("    }\r\n");
this.WriteObjects("}\r\n");
