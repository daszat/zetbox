...
{
    [Arebis.CodeGeneration.TemplateInfo(@"D:\Projects\zetbox.net4\Zetbox.Generator\Templates\ProjectFile.cst")]
    public partial class ProjectFile : Zetbox.Generator.ResourceTemplate
    {
        ...
        {
#line 27 "D:\Projects\zetbox.net4\Zetbox.Generator\Templates\ProjectFile.cst"
...
this.WriteObjects("    <TargetFrameworkProfile />\r\n");
this.WriteObjects("  </PropertyGroup>\r\n");
...
this.WriteObjects("    <OutputPath Condition=\" '$(OutputPathOverride)' == '' \">..\\bin\\Debug\\",  GetRelativeOutputPath().Replace('/', '\\') , "\\",  RelativeExternBuildOutputSubDirectory , "\\</OutputPath>\r\n");
...
this.WriteObjects("    <TreatWarningsAsErrors>true</TreatWarningsAsErrors>\r\n");
this.WriteObjects("    <!-- hardcode output path for external builds; the generator replaces this value from configuration -->\r\n");
this.WriteObjects("    <OutputPath Condition=\" '$(OutputPathOverride)' == '' \">..\\bin\\Release\\",  GetRelativeOutputPath().Replace('/', '\\') , "\\",  RelativeExternBuildOutputSubDirectory , "\\</OutputPath>\r\n");
this.WriteObjects("    <OutputPath Condition=\" '$(OutputPathOverride)' != '' \">$(OutputPathOverride)\\",  GetRelativeOutputPath().Replace('/', '\\') , "\\Generated\\</OutputPath>\r\n");
...
this.WriteObjects("  <PropertyGroup>\r\n");
#line 96 "D:\Projects\zetbox.net4\Zetbox.Generator\Templates\ProjectFile.cst"
ApplyAdditionalProperties(); 
#line 97 "D:\Projects\zetbox.net4\Zetbox.Generator\Templates\ProjectFile.cst"
this.WriteObjects("  </PropertyGroup>\r\n");
...
this.WriteObjects("      <SpecificVersion>False</SpecificVersion>\r\n");
this.WriteObjects("      <HintPath>$(ZetboxAPIPath)\\Common\\Autofac.dll</HintPath>\r\n");
this.WriteObjects("      <Private>False</Private>\r\n");
this.WriteObjects("    </Reference>\r\n");
this.WriteObjects("    <Reference Include=\"WindowsBase\">\r\n");
this.WriteObjects("      <RequiredTargetFramework>3.5</RequiredTargetFramework>\r\n");
this.WriteObjects("    </Reference>\r\n");
#line 124 "D:\Projects\zetbox.net4\Zetbox.Generator\Templates\ProjectFile.cst"
ApplyAdditionalReferences(); 
#line 125 "D:\Projects\zetbox.net4\Zetbox.Generator\Templates\ProjectFile.cst"
this.WriteObjects("  </ItemGroup>\r\n");
this.WriteObjects("  <ItemGroup>\r\n");
#line 127 "D:\Projects\zetbox.net4\Zetbox.Generator\Templates\ProjectFile.cst"
foreach (var name in fileNames) { 
#line 128 "D:\Projects\zetbox.net4\Zetbox.Generator\Templates\ProjectFile.cst"
this.WriteObjects("    <Compile Include=\"",  name.Replace('/', '\\') , "\" />\r\n");
#line 129 "D:\Projects\zetbox.net4\Zetbox.Generator\Templates\ProjectFile.cst"
} 
#line 130 "D:\Projects\zetbox.net4\Zetbox.Generator\Templates\ProjectFile.cst"
this.WriteObjects("  </ItemGroup>\r\n");
this.WriteObjects("  <ItemGroup>\r\n");
this.WriteObjects("    <None Include=\"Zetbox.Objects.snk\" />\r\n");
this.WriteObjects("  </ItemGroup>\r\n");
#line 134 "D:\Projects\zetbox.net4\Zetbox.Generator\Templates\ProjectFile.cst"
ApplyAdditionalItemGroups(); 
#line 135 "D:\Projects\zetbox.net4\Zetbox.Generator\Templates\ProjectFile.cst"
...
this.WriteObjects("  </Target>\r\n");
#line 143 "D:\Projects\zetbox.net4\Zetbox.Generator\Templates\ProjectFile.cst"
ApplyAdditionalPropertyGroups(); 
#line 144 "D:\Projects\zetbox.net4\Zetbox.Generator\Templates\ProjectFile.cst"
