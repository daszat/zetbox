...
{
    [Arebis.CodeGeneration.TemplateInfo(@"D:\Projects\zetbox.core\Zetbox.Generator\Templates\Properties\ObjectListProperty.cst")]
    public partial class ObjectListProperty : Zetbox.Generator.MemberTemplate
    {
        ...
        {
#line 41 "D:\Projects\zetbox.core\Zetbox.Generator\Templates\Properties\ObjectListProperty.cst"
...
#line 52 "D:\Projects\zetbox.core\Zetbox.Generator\Templates\Properties\ObjectListProperty.cst"
...
this.WriteObjects("            {\r\n");
#line 77 "D:\Projects\zetbox.core\Zetbox.Generator\Templates\Properties\ObjectListProperty.cst"
if (eagerLoading) { 
#line 78 "D:\Projects\zetbox.core\Zetbox.Generator\Templates\Properties\ObjectListProperty.cst"
...
this.WriteObjects("                        });\r\n");
this.WriteObjects("                }\r\n");
#line 94 "D:\Projects\zetbox.core\Zetbox.Generator\Templates\Properties\ObjectListProperty.cst"
} else { 
#line 95 "D:\Projects\zetbox.core\Zetbox.Generator\Templates\Properties\ObjectListProperty.cst"
this.WriteObjects("                ",  taskName , " = Context.GetListOfAsync<",  referencedInterface , ">(this, \"",  name , "\")\r\n");
this.WriteObjects("                    .OnResult(t =>\r\n");
this.WriteObjects("                    {\r\n");
this.WriteObjects("                        serverList = t.Result;\r\n");
this.WriteObjects("                    });\r\n");
#line 100 "D:\Projects\zetbox.core\Zetbox.Generator\Templates\Properties\ObjectListProperty.cst"
} 
#line 101 "D:\Projects\zetbox.core\Zetbox.Generator\Templates\Properties\ObjectListProperty.cst"
this.WriteObjects("            }\r\n");
this.WriteObjects("            else\r\n");
this.WriteObjects("            {\r\n");
this.WriteObjects("                ",  taskName , " = new Zetbox.API.Async.ZbTask(Zetbox.API.Async.ZbTask.Synchron, () =>\r\n");
...
this.WriteObjects("                    ");
#line 114 "D:\Projects\zetbox.core\Zetbox.Generator\Templates\Properties\ObjectListProperty.cst"
...
#line 131 "D:\Projects\zetbox.core\Zetbox.Generator\Templates\Properties\ObjectListProperty.cst"
if (eagerLoading)
    {

#line 134 "D:\Projects\zetbox.core\Zetbox.Generator\Templates\Properties\ObjectListProperty.cst"
this.WriteObjects("        private List<int> ",  name , "Ids;\r\n");
this.WriteObjects("        private bool ",  name , "_was_eagerLoaded = false;\r\n");
#line 137 "D:\Projects\zetbox.core\Zetbox.Generator\Templates\Properties\ObjectListProperty.cst"
}
