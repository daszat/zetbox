...
{
    [Arebis.CodeGeneration.TemplateInfo(@"D:\Projects\zetbox.core\Zetbox.Generator\Templates\Serialization\CompoundObjectSerialization.cst")]
    public partial class CompoundObjectSerialization : Zetbox.Generator.ResourceTemplate
    {
        ...
        {
#line 38 "D:\Projects\zetbox.core\Zetbox.Generator\Templates\Serialization\CompoundObjectSerialization.cst"
if (direction == SerializerDirection.ToStream)
    {

#line 41 "D:\Projects\zetbox.core\Zetbox.Generator\Templates\Serialization\CompoundObjectSerialization.cst"
this.WriteObjects("            ",  streamName , ".Write(this.",  memberName , ");\r\n");
#line 43 "D:\Projects\zetbox.core\Zetbox.Generator\Templates\Serialization\CompoundObjectSerialization.cst"
}
    else if (direction == SerializerDirection.FromStream)
    {

#line 47 "D:\Projects\zetbox.core\Zetbox.Generator\Templates\Serialization\CompoundObjectSerialization.cst"
this.WriteObjects("            {\r\n");
...
this.WriteObjects("            }\r\n");
#line 53 "D:\Projects\zetbox.core\Zetbox.Generator\Templates\Serialization\CompoundObjectSerialization.cst"
}
    else if (direction == SerializerDirection.Export)
    {

#line 57 "D:\Projects\zetbox.core\Zetbox.Generator\Templates\Serialization\CompoundObjectSerialization.cst"
...
#line 59 "D:\Projects\zetbox.core\Zetbox.Generator\Templates\Serialization\CompoundObjectSerialization.cst"
}
    else if (direction == SerializerDirection.MergeImport)
    {

#line 63 "D:\Projects\zetbox.core\Zetbox.Generator\Templates\Serialization\CompoundObjectSerialization.cst"
...
#line 67 "D:\Projects\zetbox.core\Zetbox.Generator\Templates\Serialization\CompoundObjectSerialization.cst"
}
    else
    {
