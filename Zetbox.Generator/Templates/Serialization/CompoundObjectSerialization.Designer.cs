...
{
    [Arebis.CodeGeneration.TemplateInfo(@"C:\Projects\zetbox\Zetbox.Generator\Templates\Serialization\CompoundObjectSerialization.cst")]
    public partial class CompoundObjectSerialization : Zetbox.Generator.ResourceTemplate
    {
        ...
        {
#line 38 "C:\Projects\zetbox\Zetbox.Generator\Templates\Serialization\CompoundObjectSerialization.cst"
if (direction == SerializerDirection.ToStream)
    {

#line 41 "C:\Projects\zetbox\Zetbox.Generator\Templates\Serialization\CompoundObjectSerialization.cst"
this.WriteObjects("            ",  streamName , ".Write(this.",  memberName , ");\r\n");
#line 43 "C:\Projects\zetbox\Zetbox.Generator\Templates\Serialization\CompoundObjectSerialization.cst"
}
    else if (direction == SerializerDirection.FromStream)
    {

#line 47 "C:\Projects\zetbox\Zetbox.Generator\Templates\Serialization\CompoundObjectSerialization.cst"
this.WriteObjects("            {\r\n");
...
this.WriteObjects("            }\r\n");
#line 53 "C:\Projects\zetbox\Zetbox.Generator\Templates\Serialization\CompoundObjectSerialization.cst"
}
    else if (direction == SerializerDirection.Export)
    {

#line 57 "C:\Projects\zetbox\Zetbox.Generator\Templates\Serialization\CompoundObjectSerialization.cst"
...
#line 59 "C:\Projects\zetbox\Zetbox.Generator\Templates\Serialization\CompoundObjectSerialization.cst"
}
    else if (direction == SerializerDirection.MergeImport)
    {

#line 63 "C:\Projects\zetbox\Zetbox.Generator\Templates\Serialization\CompoundObjectSerialization.cst"
...
#line 67 "C:\Projects\zetbox\Zetbox.Generator\Templates\Serialization\CompoundObjectSerialization.cst"
}
    else
    {
