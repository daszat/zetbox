...
#line 38 "P:\zetbox\Zetbox.Generator\Templates\ObjectClasses\AttachToContextTemplate.cst"
...
#line 41 "P:\zetbox\Zetbox.Generator\Templates\ObjectClasses\AttachToContextTemplate.cst"
}

            foreach(var prop in cls.Properties.OfType<CompoundObjectProperty>().Where(p => p.IsList).OrderBy(p => p.Name))
            {

#line 46 "P:\zetbox\Zetbox.Generator\Templates\ObjectClasses\AttachToContextTemplate.cst"
this.WriteObjects("            if (_",  prop.Name , "Collection != null)\n");
this.WriteObjects("                _",  prop.Name , "Collection.ForEach<IPersistenceObject>(i => ctx.Attach(i));\n");
#line 49 "P:\zetbox\Zetbox.Generator\Templates\ObjectClasses\AttachToContextTemplate.cst"
}

#line 51 "P:\zetbox\Zetbox.Generator\Templates\ObjectClasses\AttachToContextTemplate.cst"
this.WriteObjects("        }\n");
