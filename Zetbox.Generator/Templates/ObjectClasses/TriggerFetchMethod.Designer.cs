...
{
    [Arebis.CodeGeneration.TemplateInfo(@"C:\Projects\zetbox\Zetbox.Generator\Templates\ObjectClasses\TriggerFetchMethod.cst")]
    public partial class TriggerFetchMethod : Zetbox.Generator.ResourceTemplate
    {
        ...
        {
#line 30 "C:\Projects\zetbox\Zetbox.Generator\Templates\ObjectClasses\TriggerFetchMethod.cst"
this.WriteObjects("\r\n");
this.WriteObjects("        public override Zetbox.API.Async.ZbTask TriggerFetch(string propName)\r\n");
this.WriteObjects("        {\r\n");
this.WriteObjects("            switch(propName)\r\n");
this.WriteObjects("            {\r\n");
#line 35 "C:\Projects\zetbox\Zetbox.Generator\Templates\ObjectClasses\TriggerFetchMethod.cst"
foreach(var p in propertyNames) {   
#line 36 "C:\Projects\zetbox\Zetbox.Generator\Templates\ObjectClasses\TriggerFetchMethod.cst"
this.WriteObjects("            case \"",  p , "\":\r\n");
this.WriteObjects("                return TriggerFetch",  p , "Async();\r\n");
#line 38 "C:\Projects\zetbox\Zetbox.Generator\Templates\ObjectClasses\TriggerFetchMethod.cst"
}                                            
#line 39 "C:\Projects\zetbox\Zetbox.Generator\Templates\ObjectClasses\TriggerFetchMethod.cst"
