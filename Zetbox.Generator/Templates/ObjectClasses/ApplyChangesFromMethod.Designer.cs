...
{
    [Arebis.CodeGeneration.TemplateInfo(@"D:\Projects\zetbox.core\Zetbox.Generator\Templates\ObjectClasses\ApplyChangesFromMethod.cst")]
    public partial class ApplyChangesFromMethod : Zetbox.Generator.ResourceTemplate
    {
        ...
        {
#line 35 "D:\Projects\zetbox.core\Zetbox.Generator\Templates\ObjectClasses\ApplyChangesFromMethod.cst"
this.WriteObjects("\r\n");
...
this.WriteObjects("\r\n");
#line 43 "D:\Projects\zetbox.core\Zetbox.Generator\Templates\ObjectClasses\ApplyChangesFromMethod.cst"
foreach(var prop in cls.Properties.OfType<ValueTypeProperty>().Where(p => !p.IsCalculated && !p.IsList).OrderBy(p => p.Name)) { 
#line 44 "D:\Projects\zetbox.core\Zetbox.Generator\Templates\ObjectClasses\ApplyChangesFromMethod.cst"
var propName = prop.Name;                                                                                                  
#line 45 "D:\Projects\zetbox.core\Zetbox.Generator\Templates\ObjectClasses\ApplyChangesFromMethod.cst"
this.WriteObjects("            me.",  propName , " = other.",  propName , ";\r\n");
#line 46 "D:\Projects\zetbox.core\Zetbox.Generator\Templates\ObjectClasses\ApplyChangesFromMethod.cst"
} 
#line 47 "D:\Projects\zetbox.core\Zetbox.Generator\Templates\ObjectClasses\ApplyChangesFromMethod.cst"
foreach(var prop in cls.Properties.OfType<CompoundObjectProperty>().Where(p => !p.IsList /* && !p.IsCalculated */).OrderBy(p => p.Name)) { 
#line 48 "D:\Projects\zetbox.core\Zetbox.Generator\Templates\ObjectClasses\ApplyChangesFromMethod.cst"
var propName = prop.Name;                                                                                                  
#line 49 "D:\Projects\zetbox.core\Zetbox.Generator\Templates\ObjectClasses\ApplyChangesFromMethod.cst"
...
this.WriteObjects("            }\r\n");
#line 56 "D:\Projects\zetbox.core\Zetbox.Generator\Templates\ObjectClasses\ApplyChangesFromMethod.cst"
} 
#line 57 "D:\Projects\zetbox.core\Zetbox.Generator\Templates\ObjectClasses\ApplyChangesFromMethod.cst"
...
#line 62 "D:\Projects\zetbox.core\Zetbox.Generator\Templates\ObjectClasses\ApplyChangesFromMethod.cst"
this.WriteObjects("            this.",  positionPropertyName , " = otherImpl.",  positionPropertyName , ";\r\n");
#line 63 "D:\Projects\zetbox.core\Zetbox.Generator\Templates\ObjectClasses\ApplyChangesFromMethod.cst"
} 
#line 64 "D:\Projects\zetbox.core\Zetbox.Generator\Templates\ObjectClasses\ApplyChangesFromMethod.cst"
this.WriteObjects("            this._fk_",  propName , " = otherImpl._fk_",  propName , ";\r\n");
#line 65 "D:\Projects\zetbox.core\Zetbox.Generator\Templates\ObjectClasses\ApplyChangesFromMethod.cst"
} 
#line 66 "D:\Projects\zetbox.core\Zetbox.Generator\Templates\ObjectClasses\ApplyChangesFromMethod.cst"
this.WriteObjects("        }\r\n");
