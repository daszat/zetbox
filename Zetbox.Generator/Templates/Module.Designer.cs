...
namespace Zetbox.Generator.Templates
{
    ...
    public partial class Module : Zetbox.Generator.ResourceTemplate
    {
        ...
        {
#line 11 "P:\Zetbox\Zetbox.Generator\Templates\Module.cst"
...
#line 21 "P:\Zetbox\Zetbox.Generator\Templates\Module.cst"
foreach(string ns in GetAdditionalImports().OrderBy(s => s).Distinct().OrderBy(s => s)) { 
#line 22 "P:\Zetbox\Zetbox.Generator\Templates\Module.cst"
this.WriteObjects("    using ",  ns , ";\r\n");
#line 23 "P:\Zetbox\Zetbox.Generator\Templates\Module.cst"
} 
#line 24 "P:\Zetbox\Zetbox.Generator\Templates\Module.cst"
this.WriteObjects("\r\n");
...
this.WriteObjects("\r\n");
#line 32 "P:\Zetbox\Zetbox.Generator\Templates\Module.cst"
ApplyRegistrations(); 
#line 33 "P:\Zetbox\Zetbox.Generator\Templates\Module.cst"
this.WriteObjects("        }\r\n");
this.WriteObjects("    }\r\n");
this.WriteObjects("\r\n");
#line 36 "P:\Zetbox\Zetbox.Generator\Templates\Module.cst"
