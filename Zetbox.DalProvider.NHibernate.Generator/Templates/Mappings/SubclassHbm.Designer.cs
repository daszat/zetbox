...
{
    [Arebis.CodeGeneration.TemplateInfo(@"D:\Projects\zetbox.net4\Zetbox.DalProvider.NHibernate.Generator\Templates\Mappings\SubclassHbm.cst")]
    public partial class SubclassHbm : Zetbox.Generator.ResourceTemplate
    {
        ...
        {
#line 43 "D:\Projects\zetbox.net4\Zetbox.DalProvider.NHibernate.Generator\Templates\Mappings\SubclassHbm.cst"
...
#line 46 "D:\Projects\zetbox.net4\Zetbox.DalProvider.NHibernate.Generator\Templates\Mappings\SubclassHbm.cst"
if(mappingType == Zetbox.App.Base.TableMapping.TPH) { 
#line 47 "D:\Projects\zetbox.net4\Zetbox.DalProvider.NHibernate.Generator\Templates\Mappings\SubclassHbm.cst"
this.WriteObjects("                discriminator-value=\"",  schemaName , ".",  tableName , "\"\r\n");
#line 48 "D:\Projects\zetbox.net4\Zetbox.DalProvider.NHibernate.Generator\Templates\Mappings\SubclassHbm.cst"
} else { 
#line 49 "D:\Projects\zetbox.net4\Zetbox.DalProvider.NHibernate.Generator\Templates\Mappings\SubclassHbm.cst"
this.WriteObjects("                schema=\"`",  schemaName , "`\"\r\n");
this.WriteObjects("                table=\"`",  tableName , "`\"\r\n");
#line 51 "D:\Projects\zetbox.net4\Zetbox.DalProvider.NHibernate.Generator\Templates\Mappings\SubclassHbm.cst"
} 
#line 52 "D:\Projects\zetbox.net4\Zetbox.DalProvider.NHibernate.Generator\Templates\Mappings\SubclassHbm.cst"
this.WriteObjects("                dynamic-update=\"",  needsConcurrency ? "true" : "false" , "\">\r\n");
this.WriteObjects("            \r\n");
#line 54 "D:\Projects\zetbox.net4\Zetbox.DalProvider.NHibernate.Generator\Templates\Mappings\SubclassHbm.cst"
if(mappingType == Zetbox.App.Base.TableMapping.TPT) { 
#line 55 "D:\Projects\zetbox.net4\Zetbox.DalProvider.NHibernate.Generator\Templates\Mappings\SubclassHbm.cst"
this.WriteObjects("            <!-- base class reference -->\r\n");
this.WriteObjects("            <key column=\"`ID`\" />\r\n");
#line 57 "D:\Projects\zetbox.net4\Zetbox.DalProvider.NHibernate.Generator\Templates\Mappings\SubclassHbm.cst"
} 
#line 58 "D:\Projects\zetbox.net4\Zetbox.DalProvider.NHibernate.Generator\Templates\Mappings\SubclassHbm.cst"
this.WriteObjects("\r\n");
this.WriteObjects("            <!-- define the properties -->\r\n");
#line 60 "D:\Projects\zetbox.net4\Zetbox.DalProvider.NHibernate.Generator\Templates\Mappings\SubclassHbm.cst"
ApplyPropertyDefinitions(properties); 
#line 61 "D:\Projects\zetbox.net4\Zetbox.DalProvider.NHibernate.Generator\Templates\Mappings\SubclassHbm.cst"
this.WriteObjects("\r\n");
this.WriteObjects("            <!-- define the subclasses -->\r\n");
#line 63 "D:\Projects\zetbox.net4\Zetbox.DalProvider.NHibernate.Generator\Templates\Mappings\SubclassHbm.cst"
ApplySubclasses(subClasses); 
#line 64 "D:\Projects\zetbox.net4\Zetbox.DalProvider.NHibernate.Generator\Templates\Mappings\SubclassHbm.cst"
this.WriteObjects("\r\n");
this.WriteObjects("        </",  GetTagName() , ">\r\n");
