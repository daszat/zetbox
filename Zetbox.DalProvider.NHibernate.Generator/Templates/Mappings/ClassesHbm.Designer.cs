...
{
    [Arebis.CodeGeneration.TemplateInfo(@"D:\Projects\zetbox.core\Zetbox.DalProvider.NHibernate.Generator\Templates\Mappings\ClassesHbm.cst")]
    public partial class ClassesHbm : Zetbox.Generator.ResourceTemplate
    {
        ...
        {
#line 28 "D:\Projects\zetbox.core\Zetbox.DalProvider.NHibernate.Generator\Templates\Mappings\ClassesHbm.cst"
...
#line 31 "D:\Projects\zetbox.core\Zetbox.DalProvider.NHibernate.Generator\Templates\Mappings\ClassesHbm.cst"
foreach (var oc in GetObjectClasses(ctx).Where(c => c.BaseObjectClass == null).ToList().OrderBy(c => c.Module.Name).ThenBy(c => c.Name)) {          
#line 32 "D:\Projects\zetbox.core\Zetbox.DalProvider.NHibernate.Generator\Templates\Mappings\ClassesHbm.cst"
ApplyObjectClassTemplate(oc);                                                               
#line 33 "D:\Projects\zetbox.core\Zetbox.DalProvider.NHibernate.Generator\Templates\Mappings\ClassesHbm.cst"
}                                                                                                
#line 34 "D:\Projects\zetbox.core\Zetbox.DalProvider.NHibernate.Generator\Templates\Mappings\ClassesHbm.cst"
