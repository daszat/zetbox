...
bin\debug\bin\Server\Kistl.Server.Service.exe Configs\%zenv%\Kistl.Server.Service.xml -import Kistl.Server\Database\SchemaMigrationProjects.xml SchemaMigration
IF ERRORLEVEL 1 GOTO FAIL

rem re-migrate Ini50 data
bin\debug\bin\Server\Ini50.Migrate.exe Configs\%zenv%\Ini50.Migrate.xml
IF ERRORLEVEL 1 GOTO FAIL
