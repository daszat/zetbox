...
namespace Kistl.Client.Presentables
{
    ...
    //    : ValueViewModel<ICollection<string>>, IValueListViewModel<string, IReadOnlyObservableList<string>>
    //{
    //    public new delegate StringListPropertyModel Factory(IKistlContext dataCtx, IValueViewModel mdl);
