...
//        public static StorageType? ToStorageType(this StorageHint hint)
//        {
//            switch (hint)
//            {
//                case StorageHint.MergeA:
//                    return StorageType.MergeIntoA;
//                case StorageHint.MergeB:
//                    return StorageType.MergeIntoB;
//                case StorageHint.Replicate:
//                    return StorageType.Replicate;
//                case StorageHint.Separate:
//                    return StorageType.Separate;
