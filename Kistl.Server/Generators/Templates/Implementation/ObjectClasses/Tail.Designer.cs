...
this.WriteObjects("        }\r\n");
this.WriteObjects("        public static event ToStringHandler<",  cls.ClassName , "> OnToString_",  cls.ClassName , ";\r\n");
this.WriteObjects("\r\n");
...
this.WriteObjects("        }\r\n");
this.WriteObjects("        public static event ObjectEventHandler<",  cls.ClassName , "> OnPreSave_",  cls.ClassName , ";\r\n");
this.WriteObjects("\r\n");
...
this.WriteObjects("        }\r\n");
this.WriteObjects("        public static event ObjectEventHandler<",  cls.ClassName , "> OnPostSave_",  cls.ClassName , ";\r\n");
this.WriteObjects("\r\n");
...
this.WriteObjects("        }\r\n");
this.WriteObjects("        public static event ObjectEventHandler<",  cls.ClassName , "> OnCreated_",  cls.ClassName , ";\r\n");
this.WriteObjects("\r\n");
...
this.WriteObjects("        }\r\n");
this.WriteObjects("        public static event ObjectEventHandler<",  cls.ClassName , "> OnDeleting_",  cls.ClassName , ";\r\n");
this.WriteObjects("\r\n");
