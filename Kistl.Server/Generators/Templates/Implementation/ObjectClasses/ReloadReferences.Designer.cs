...
{
    [Arebis.CodeGeneration.TemplateInfo(@"P:\Kistl\Kistl.Server\Generators\Templates\Implementation\ObjectClasses\ReloadReferences.cst")]
...
#line 22 "P:\Kistl\Kistl.Server\Generators\Templates\Implementation\ObjectClasses\ReloadReferences.cst"
if (cls.BaseObjectClass != null) {

#line 24 "P:\Kistl\Kistl.Server\Generators\Templates\Implementation\ObjectClasses\ReloadReferences.cst"
this.WriteObjects("			base.ReloadReferences();\r\n");
this.WriteObjects("			\r\n");
#line 27 "P:\Kistl\Kistl.Server\Generators\Templates\Implementation\ObjectClasses\ReloadReferences.cst"
}

#line 29 "P:\Kistl\Kistl.Server\Generators\Templates\Implementation\ObjectClasses\ReloadReferences.cst"
this.WriteObjects("			// fix direct object references\r\n");
#line 31 "P:\Kistl\Kistl.Server\Generators\Templates\Implementation\ObjectClasses\ReloadReferences.cst"
foreach(var prop in cls.Properties.OfType<ObjectReferenceProperty>()
		...
		.ThenBy(orp => orp.Name))
	{
		...
		ReloadOneReference.Call(Host, ctx, referencedInterface, referencedImplementation, name, implName, fkBackingName, fkGuidBackingName);
	}

#line 50 "P:\Kistl\Kistl.Server\Generators\Templates\Implementation\ObjectClasses\ReloadReferences.cst"
this.WriteObjects("		}");
