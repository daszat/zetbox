...
#line 26 "P:\Kistl\Kistl.Server\Generators\Templates\Implementation\ObjectClasses\GetPropertyErrorTemplate.cst"
...
#line 32 "P:\Kistl\Kistl.Server\Generators\Templates\Implementation\ObjectClasses\GetPropertyErrorTemplate.cst"
...
#line 40 "P:\Kistl\Kistl.Server\Generators\Templates\Implementation\ObjectClasses\GetPropertyErrorTemplate.cst"
}
...
#line 52 "P:\Kistl\Kistl.Server\Generators\Templates\Implementation\ObjectClasses\GetPropertyErrorTemplate.cst"
} else {

#line 54 "P:\Kistl\Kistl.Server\Generators\Templates\Implementation\ObjectClasses\GetPropertyErrorTemplate.cst"
...
#line 62 "P:\Kistl\Kistl.Server\Generators\Templates\Implementation\ObjectClasses\GetPropertyErrorTemplate.cst"
}
		}
...
#line 68 "P:\Kistl\Kistl.Server\Generators\Templates\Implementation\ObjectClasses\GetPropertyErrorTemplate.cst"
this.WriteObjects("			// skipping position columns for frozen context (not implemented)\r\n");
#line 70 "P:\Kistl\Kistl.Server\Generators\Templates\Implementation\ObjectClasses\GetPropertyErrorTemplate.cst"
} else {		
			foreach(var rel in rels.Where(r => r.GetRelationType() == RelationType.one_n))
			{

#line 74 "P:\Kistl\Kistl.Server\Generators\Templates\Implementation\ObjectClasses\GetPropertyErrorTemplate.cst"
this.WriteObjects("			// rel: ",  rel.A.RoleName , " ",  rel.Verb , " ",  rel.B.RoleName , " (",  rel.ExportGuid , ")\r\n");
#line 76 "P:\Kistl\Kistl.Server\Generators\Templates\Implementation\ObjectClasses\GetPropertyErrorTemplate.cst"
if (rel.A.Type == cls && rel.A.HasPersistentOrder) 
			{
				var posColumnName = Construct.ListPositionPropertyName(rel.A);

#line 80 "P:\Kistl\Kistl.Server\Generators\Templates\Implementation\ObjectClasses\GetPropertyErrorTemplate.cst"
...
#line 88 "P:\Kistl\Kistl.Server\Generators\Templates\Implementation\ObjectClasses\GetPropertyErrorTemplate.cst"
}
...
#line 94 "P:\Kistl\Kistl.Server\Generators\Templates\Implementation\ObjectClasses\GetPropertyErrorTemplate.cst"
...
this.WriteObjects("				obj => obj.",  posColumnName , ",\r\n");
this.WriteObjects("				(obj, val) => obj.",  posColumnName , " = val),\r\n");
#line 102 "P:\Kistl\Kistl.Server\Generators\Templates\Implementation\ObjectClasses\GetPropertyErrorTemplate.cst"
}
			}
		}

#line 106 "P:\Kistl\Kistl.Server\Generators\Templates\Implementation\ObjectClasses\GetPropertyErrorTemplate.cst"
this.WriteObjects("		};\r\n");
this.WriteObjects("		\r\n");
...
this.WriteObjects("		}\r\n");
#line 113 "P:\Kistl\Kistl.Server\Generators\Templates\Implementation\ObjectClasses\GetPropertyErrorTemplate.cst"
}

#line 115 "P:\Kistl\Kistl.Server\Generators\Templates\Implementation\ObjectClasses\GetPropertyErrorTemplate.cst"
this.WriteObjects("	\r\n");
