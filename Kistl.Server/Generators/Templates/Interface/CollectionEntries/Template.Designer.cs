...
namespace Kistl.Server.Generators.Templates.Interface.CollectionEntries
{
    ...
    public partial class Template : Kistl.Server.Generators.KistlCodeTemplate
    {
        ...
        public static void Call(Arebis.CodeGeneration.IGenerationHost _host, IKistlContext ctx, Kistl.App.Base.Module module)
        {
            ...
            _host.CallTemplate("Interface.CollectionEntries.Template", ctx, module);
        }
        ...
        {
#line 14 "P:\Kistl\Kistl.Server\Generators\Templates\Interface\CollectionEntries\Template.cst"
this.WriteObjects("// <autogenerated/>\r\n");
this.WriteObjects("\r\n");
this.WriteObjects("namespace ",  module.Namespace , "\r\n");
this.WriteObjects("{\r\n");
this.WriteObjects("    using Kistl.API;\r\n");
#line 20 "P:\Kistl\Kistl.Server\Generators\Templates\Interface\CollectionEntries\Template.cst"
...
#line 27 "P:\Kistl\Kistl.Server\Generators\Templates\Interface\CollectionEntries\Template.cst"
this.WriteObjects("\r\n");
