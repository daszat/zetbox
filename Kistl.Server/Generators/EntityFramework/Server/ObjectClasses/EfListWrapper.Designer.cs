...
using Kistl.Server.Generators.EntityFramework.Server;
using Kistl.Server.Generators.Extensions;


namespace Kistl.Server.Generators.EntityFramework.Server.ObjectClasses
{
    [Arebis.CodeGeneration.TemplateInfo(@"P:\Kistl\Kistl.Server\Generators\EntityFramework\Server\ObjectClasses\EfListWrapper.cst")]
    public partial class EfListWrapper : Kistl.Server.Generators.KistlCodeTemplate
    {
        ...
        {
#line 13 "P:\Kistl\Kistl.Server\Generators\EntityFramework\Server\ObjectClasses\EfListWrapper.cst"
this.WriteObjects("\r\n");
#line 18 "P:\Kistl\Kistl.Server\Generators\EntityFramework\Server\ObjectClasses\EfListWrapper.cst"
