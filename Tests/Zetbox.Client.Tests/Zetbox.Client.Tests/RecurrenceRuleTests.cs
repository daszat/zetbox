...
namespace Zetbox.Client.Tests
{
    ...
    public class RecurrenceRuleTests : AbstractClientTestFixture
    {
        ...
        [Test]
        public async Task when_yearly_current()
        {
            rule.Frequency = Frequency.Yearly;

            var result = await rule.GetCurrent(start, now);
        ...
        [Test]
        public async Task when_yearly_next()
        {
            rule.Frequency = Frequency.Yearly;

            var result = await rule.GetNext(start, now);
        ...
        [Test]
        public async Task when_quaterly_current()
        {
        ...
        [Test]
        public async Task when_quaterly_next()
        {
            rule.Frequency = Frequency.Monthly;
            rule.Interval = 3;
        ...
        [Test]
        public async Task when_monthly_current()
        {
            rule.Frequency = Frequency.Monthly;
        ...
        [Test]
        public async Task when_monthly_next()
        {
            rule.Frequency = Frequency.Monthly;
        ...
        [Test]
        public async Task when_monthly_first_current()
        {
            rule.Frequency = Frequency.Monthly;
            rule.ByMonthDay = "1";
        ...
        [Test]
        public async Task when_monthly_first_next()
        {
            rule.Frequency = Frequency.Monthly;
            rule.ByMonthDay = "1";
        ...
        [Test]
        public async Task when_monthly_last_current()
        {
            rule.Frequency = Frequency.Monthly;
            rule.ByMonthDay = "-1";
        ...
        [Test]
        public async Task when_monthly_last_next()
        {
            rule.Frequency = Frequency.Monthly;
            rule.ByMonthDay = "-1";
        ...
        public async Task as_relative_monthly_last_next(int sy, int sm, int sd, int ey, int em, int ed)
        {
            rule.Frequency = Frequency.Monthly;
            rule.ByMonthDay = "-1";
            var dt = new DateTime(sy, sm, sd);

            var result = await rule.GetNext(dt, dt);
        ...
        public async Task as_relative_monthly_5th_next(int sy, int sm, int sd, int ey, int em, int ed)
        {
            rule.Frequency = Frequency.Monthly;
            rule.ByMonthDay = "5";
            var dt = new DateTime(sy, sm, sd);
        ...
        public async Task as_relative_monthly_interval_2_last_next(int sy, int sm, int sd, int ey, int em, int ed)
        {
            rule.Frequency = Frequency.Monthly;
            rule.Interval = 2;
            rule.ByMonthDay = "-1";
        ...
        [TestCase(2013, 7, 5, 2013, 8, 5)]
        [TestCase(2013, 7, 19, 2013, 8, 5)]
        public async Task as_relative_on_next_5th(int sy, int sm, int sd, int ey, int em, int ed)
        {
            rule.Frequency = Frequency.Monthly;
            rule.ByMonthDay = "5";
            var dt = new DateTime(sy, sm, sd);

            var result = await rule.GetRelative(dt);
            Assert.That(result, Is.EqualTo(new DateTime(ey, em, ed)));
            Assert.That(result.TimeOfDay, Is.EqualTo(TimeSpan.Zero));
        }
        ...
        public async Task as_relative_on_next_months_15th(int sy, int sm, int sd, int ey, int em, int ed)
        {
            rule.Frequency = Frequency.Monthly;
            rule.Interval = 1;
            rule.ByMonthDay = "15";
        ...
        [Test]
        public async Task when_weekly_current()
        {
        ...
        [Test]
        public async Task when_weekly_next()
        {
            rule.Frequency = Frequency.Weekly;
        ...
        [Test]
        public async Task when_mondays_current()
        {
            rule.Frequency = Frequency.Weekly;
            rule.ByDay = "MO";
        ...
        [Test]
        public async Task when_mondays_next()
        {
            rule.Frequency = Frequency.Weekly;
            rule.ByDay = "MO";
        ...
        [Test]
        public async Task when_daily_current()
        {
        ...
        [Test]
        public async Task when_daily_next()
        {
            rule.Frequency = Frequency.Daily;
