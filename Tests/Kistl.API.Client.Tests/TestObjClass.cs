...
namespace Kistl.API.Client.Tests
{
    ...
    public class TestObjClass__Implementation__ : BaseClientDataObject, TestObjClass
    {
        ...
        private OneNRelationList<TestObjClass> _Children;
        ...
        public IList<TestObjClass> Children
        {
            get
            {
                if (_Children == null) _Children = new OneNRelationList<TestObjClass>("Parent", "Parent_pos", this, () => NotifyPropertyChanged("Children", null, null), Context.GetListOf<TestObjClass>(this, "Children"));
                return _Children;
            }
        }
        ...
        public override void AttachToContext(IKistlContext ctx)
        {
            ...
            if (_Children != null) _Children = new OneNRelationList<TestObjClass>("Parent", "Parent_pos", this, () => NotifyPropertyChanged("Children", null, null), _Children.Select(i => ctx.Attach(i)).OfType<TestObjClass>());
        }
